...
#ifndef SWIFTLINKPREVIEW_SWIFT_H
#define SWIFTLINKPREVIEW_SWIFT_H
...
# undef any
# pragma clang attribute push(__attribute__((external_source_symbol(language="Swift", defined_in="SwiftLinkPreview",generated_declaration))), apply_to=any(function,enum,objc_interface,objc_category,objc_protocol))
# pragma pop_macro("any")
#endif


SWIFT_CLASS("_TtC16SwiftLinkPreview11Cancellable")
...
SWIFT_CLASS("_TtC16SwiftLinkPreview16SwiftLinkPreview")
...
@interface SwiftLinkPreview (SWIFT_EXTENSION(SwiftLinkPreview)) <NSURLSessionDataDelegate>
